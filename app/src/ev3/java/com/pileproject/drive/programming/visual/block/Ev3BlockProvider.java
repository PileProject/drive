...
import com.pileproject.drive.programming.visual.block.selection.car.IfThereIsAnObstacleBlock;
 ...
 */
public class Ev3BlockProvider implements BlockProvider {
    ...
    public List<Class<? extends BlockBase>> getSelectionBlockClasses() {
        ...
        List<Class<? extends BlockBase>> list = Arrays.<Class<? extends BlockBase>> asList(
                ...
                IfThereIsAnObstacleBlock.class
        );
