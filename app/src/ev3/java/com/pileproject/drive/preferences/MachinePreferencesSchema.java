...
public class MachinePreferencesSchema {
    ...
    final String inputPort2 = CarControllerBase.InputDevice.COLOR;

    @Key(name = "input_port_3")
    final String inputPort3 = CarControllerBase.InputDevice.RANGEFINDER;
    ...
    @Key(name = "output_port_D")
    final String outputPortD = CarControllerBase.OutputDevice.NONE;
}
