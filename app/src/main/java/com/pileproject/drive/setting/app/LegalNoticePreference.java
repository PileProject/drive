...
public class LegalNoticePreference extends DialogPreference implements SettingActivity.DialogPreferenceInterface {
    ...
    public LegalNoticePreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public LegalNoticePreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public LegalNoticePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LegalNoticePreference(Context context) {
        super(context);
    }
    ...
    public void startDialog(PreferenceFragmentCompat parent) {
        ...
        DialogFragment f = new LegalNoticeFragment();
