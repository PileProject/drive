...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ TBL_PROGRAM_DATA // name of table
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ TBL_SAVED_PROGRAMS // name of table
				+ " (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "
				+ PROGRAM_NAME + " TEXT NOT NULL, "
				+ IS_SAMPLE + " INTEGER NOT NULL, " // sample (1) or not (0)
				+ CREATED_AT + " DATETIME DEFAULT CURRENT_TIMESTAMP);");
		
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ TBL_SAVED_PROGRAM_DATA // name of table
				+ " (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "
				+ SAVED_PROGRAM_ID + " INTEGER NOT NULL, " // foreign key (TBL_SAVED_PROGAMR)
				+ BLOCK_NAME + " TEXT NOT NULL, " // class name of block
				+ BLOCK_LEFT + " INTEGER NOT NULL, " // left (x) of block
				+ BLOCK_TOP + " INTEGER NOT NULL, " // top (y) of block
				+ BLOCK_RIGHT + " INTEGER NOT NULL, " // right (x) of block
