...
public class BlockSpaceLayout extends FrameLayout {
    ...
    public boolean isOnTrash(View view) {
        if (view.getLeft() > mTrashBox.getLeft() - view.getWidth() + 20 && view.getLeft() < mTrashBox.getRight() && view.getTop() > mTrashBox.getTop() - view.getHeight() + 20 && view.getTop() < mTrashBox.getBottom()) {
            return true;
        }
        return false;
    }
