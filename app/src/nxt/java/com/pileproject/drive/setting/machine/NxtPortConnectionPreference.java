...
public class NxtPortConnectionPreference extends DialogPreference implements SettingActivity.DialogPreferenceInterface {
    ...
    private static final String FRAGMENT_TAG = "nxt_port_connection_preference";

    public NxtPortConnectionPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public NxtPortConnectionPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public NxtPortConnectionPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NxtPortConnectionPreference(Context context) {
        super(context);
    }
