...
public class NxtThresholdFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mSoundSensorSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mSoundSensorText.setText(getString(R.string.setting_threshold_unit_dB, progress + SoundSensor.SI_dB_SiMin));
            }
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                SharedPreferencesWrapper.saveIntPreference(activity, IfThereWasALargeSoundBlock.class.getName(), seekBar.getProgress() + SoundSensor.SI_dB_SiMin);
            }
        });
        ...
        mSoundSensorSeek.setProgress((savedSoundValue == -1) ? SoundSensor.SI_dB_DEFAULT - SoundSensor.SI_dB_SiMin : savedSoundValue - SoundSensor.SI_dB_SiMin);
    }
}
